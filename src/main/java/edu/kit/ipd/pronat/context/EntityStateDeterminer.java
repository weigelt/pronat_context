...
import edu.kit.ipd.pronat.context.data.ActionConcept;
...
import edu.kit.ipd.pronat.context.data.ObjectConcept;
import edu.kit.ipd.pronat.context.data.State;
import edu.kit.ipd.pronat.context.data.entities.Entity;
import edu.kit.ipd.pronat.context.data.entities.IStateOwner;
...
public class EntityStateDeterminer implements IContextAnalyzer {
	...
	/**
	 * Returns all resulting {@link State} which result from the changed States of
	 * the {@link ActionConcept} with any of the {@link State} of the
